...
public class BMIResultActivity extends AppCompatActivity {
    ...
    private RelativeLayout mbackground,increaseWeight,loseWeight;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        increaseWeight = findViewById(R.id.increasWeight);
        loseWeight = findViewById(R.id.loseWeight);

      //  increaseWeight.setOnClickListener(v -> {
       //     startActivity(new Intent(BMIResultActivity.this, PlusPoidsActivity.class));
       // });

        ////loseWeight.setOnClickListener(v -> {
           // startActivity(new Intent(BMIResultActivity.this, MoinsPoidsActivity.class));
       // });
        ...
        else if(intbmi<24.9 && intbmi>18.5 )
        {
            ...
            //mbackground.setBackgroundColor(R.color.green);
